...
def run_experiment(fold=5, epochs=200, gpu_id=0):
    ...
    checkpoint_callback = ModelCheckpoint(
        dirpath="./model_checkpointsljx20",
...
if __name__ == '__main__':
    ...
    run_experiment(fold=1, epochs=200, gpu_id=0)
    run_experiment(fold=2, epochs=200, gpu_id=0)
    run_experiment(fold=3, epochs=200, gpu_id=0)
    run_experiment(fold=4, epochs=200, gpu_id=0)

    run_experiment(fold=6, epochs=200, gpu_id=0)
    run_experiment(fold=7, epochs=200, gpu_id=0)
    run_experiment(fold=8, epochs=200, gpu_id=0)
    run_experiment(fold=9, epochs=200, gpu_id=0)

    run_experiment(fold=10, epochs=200, gpu_id=0)
    run_experiment(fold=12, epochs=200, gpu_id=0)
    run_experiment(fold=13, epochs=200, gpu_id=0)
    run_experiment(fold=14, epochs=200, gpu_id=0)

    run_experiment(fold=15, epochs=200, gpu_id=0)
    run_experiment(fold=16, epochs=200, gpu_id=0)
    run_experiment(fold=18, epochs=200, gpu_id=0)
    run_experiment(fold=19, epochs=200, gpu_id=0)

    run_experiment(fold=20, epochs=200, gpu_id=0)
    run_experiment(fold=21, epochs=200, gpu_id=0)
    run_experiment(fold=22, epochs=200, gpu_id=0)
    run_experiment(fold=24, epochs=200, gpu_id=0)

    run_experiment(fold=25, epochs=200, gpu_id=0)
    run_experiment(fold=27, epochs=200, gpu_id=0)
    run_experiment(fold=28, epochs=200, gpu_id=0)
    
    run_experiment(fold=29, epochs=200, gpu_id=0)
    run_experiment(fold=31, epochs=200, gpu_id=0)
    run_experiment(fold=0, epochs=200, gpu_id=0)
    # run_experiment(fold=30, epochs=300, gpu_id=0)

    # run_experiment(fold=11, epochs=300, gpu_id=0)
    # run_experiment(fold=17, epochs=300, gpu_id=0)
    # run_experiment(fold=23, epochs=300, gpu_id=0)
    # run_experiment(fold=26, epochs=300, gpu_id=0)
    # run_experiment(fold=5, epochs=500, gpu_id=0)

    # run_experiment(fold=11, epochs=500, gpu_id=0)
    # run_experiment(fold=17, epochs=500, gpu_id=0)
    # run_experiment(fold=23, epochs=500, gpu_id=0)
    # run_experiment(fold=26, epochs=500, gpu_id=0)
    # run_experiment(fold=30, epochs=500, gpu_id=0)
